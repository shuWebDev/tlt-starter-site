...
if ( ! $statusResults = $link->prepare("SELECT formResponses.termsConditions, students.sn, 
  students.fn, students.mi  FROM formResponses LEFT JOIN students ON 
...
if ( ! $statusResults->bind_result($tc, $sn, $fn, $mi) ) {
...
<fieldset>
  ...
  <fieldset>
    <button type="button" id="verification" class="access btn btn-lg btn-primary" disabled="disabled"><? 
      if ( '0000-00-00 00:00:00' != $tc ) echo 'Completed';
