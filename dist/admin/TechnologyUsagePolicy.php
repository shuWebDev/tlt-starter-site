...
if ( ! $statusResults = $link->prepare("SELECT formResponses.technologyUsage, students.sn, 
...
if ( ! $statusResults->bind_result($tu, $sn, $fn, $mi) ) {
...
<button type="button" id="verification" class="access btn btn-lg btn-primary" disabled="disabled"><? 
      if ( '0000-00-00 00:00:00' != $tu ) echo 'Completed';
